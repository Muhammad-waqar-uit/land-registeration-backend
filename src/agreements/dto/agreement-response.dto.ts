...
export class AgreementResponseDto {
  ...
  @ApiProperty({
    description: 'IPFS hash of signed document',
    required: false,
    nullable: true,
  })
  ...
  @ApiProperty({
    description: 'SHA-256 hash of signed document',
    required: false,
    nullable: true,
  })
  ...
  @ApiProperty({
    description: 'Agreement terms (JSON)',
    required: false,
    nullable: true,
  })
